(function() {
    angular.module('profile', [])
        ...
        .controller('ProfileController', ['$http', '$scope', '$routeParams','$rootScope', function($http, $scope, $routeParams,$rootScope) {
            //Custom Profile functionality
            $http.get('/api/userData')
                .success(function(data) {
                   $rootScope.user = data; //Expose the user data to your angular scope
                });
        }])
